...
# define RPL_MODE_N(nick, channel, size)				":HI_IRC 324 " + nick + " " + channel + " +nl " + size + "\r\n"
...
# define ERR_NICKNAMEINUSE(nick)					    ":HI_IRC 433 " + nick + " :" + nick + "\r\n"
...
# define ERR_CHANNELISFULL(nick, channel)			    ":HI_IRC 471 " + nick + " " + channel + " :Cannot join channel (+l)\r\n"
